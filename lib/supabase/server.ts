    ...
    Tables: {
      ...
      user_grades: {
        Row: {
          id: string;
          user_id: string;
          grade_7_math: number | null;
          grade_7_english: number | null;
          grade_7_science: number | null;
          grade_7_gpa: number | null;
          grade_8_math: number | null;
          grade_8_english: number | null;
          grade_8_science: number | null;
          grade_8_gpa: number | null;
          grade_9_math: number | null;
          grade_9_english: number | null;
          grade_9_science: number | null;
          grade_9_gpa: number | null;
          grade_10_math: number | null;
          grade_10_english: number | null;
          grade_10_science: number | null;
          grade_10_gpa: number | null;
